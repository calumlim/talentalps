    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interview_type', models.CharField(choices=[('virtual', 'Virtual/Online Interview'), ('meetup', 'In Person Interview'), ('other', 'Other')], max_length=80, verbose_name='interview type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.localtime)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('interview', 'Interview Set'), ('complete', 'Completed'), ('rejected', 'Rejected')], default='pending', max_length=50, verbose_name='status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.CharField(max_length=500, verbose_name='industry')),
                ...
                ('level', models.CharField(choices=[('entry', 'Entry Level'), ('associate', 'Associate Level'), ('senior', 'Senior Level'), ('director', 'Director Level'), ('executive', 'Executive Level')], max_length=50, verbose_name='level')),
                ('job_functions', models.CharField(max_length=500, verbose_name='job functions')),
                ...
                ('recommended_start_timestamp', models.DateTimeField(blank=True, null=True, verbose_name='recommended start timestamp')),
